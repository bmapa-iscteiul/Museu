...
# COMPLETO:
  ...
  0) "CloudToMongo": Insercao Mongo (troca timestamp para java, troca por "na", troca por "", colocacao na colecao, adição dos campos caso não exitam na mensagem enviada pelo sensor, de forma a não dar erro)
